...
#define CHARACTER_FISH_MOVE		(D3DXVECTOR3(0.0f,5.0f,0.0f))	// 魚の移動量
#define CHARACTER_FISH_YPOS		(10.0f)							// 位置y
#define CHARACTER_FISH_DIE_YPOS	(0.0f)							// 死亡する位置y
...
{
	// キャラクターが一定の距離未満なら
	if (CCharacter::GetPos().y <= CHARACTER_FISH_DIE_YPOS)
	{
		// 死亡処理
		Die();
	}
