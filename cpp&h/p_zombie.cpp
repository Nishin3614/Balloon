...
// コンストラクタ処理
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CP_zombie::CP_zombie() : CPlayer::CPlayer(CHARACTER_BALLOON2)
{
}
...
//	pScene		: 相手のシーン情報
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void CP_zombie::Scene_MyCollision(int const & nObjType, CScene * pScene)
{
...
//	pScene		: 相手のシーン情報
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void CP_zombie::Scene_OpponentCollision(int const & nObjType, CScene * pScene)
{
