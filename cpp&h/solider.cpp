...
//
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define SOLIDER_MOTIONFILE "data/LOAD/CHARACTER/Solider.txt"	// モーションのファイル名
...
// オーバーロードコンストラクタ(自身用)
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CSolider::CSolider() : CEnemy::CEnemy()
{
	// 総数アっプ
	m_nAllNum++;
}
...
{
	CCharacter::SetCharacter(CHARACTER_SOLIDER);
	CEnemy::Init();
}
